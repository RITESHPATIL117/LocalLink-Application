  ...
  return (
    <div className="container" style={{ padding: '40px 20px', minHeight: '80vh' }}>
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '30px' }}>
        ...
        <div>
          <h1 style={{ fontSize: '32px', fontWeight: '900', color: 'var(--color-text)', marginBottom: '4px' }}>Platform Reports</h1>
          <p style={{ color: 'var(--color-text-secondary)', fontSize: '15px' }}>Analytics and financial reporting.</p>
        </div>
      </div>

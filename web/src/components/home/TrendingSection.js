  ...
  return (
    <section className="mb-20">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h3 className="text-2xl font-black text-slate-900 tracking-tight">Trending Now</h3>
      </div>
      ...
      <div className="flex flex-wrap gap-4">
        {TRENDING.map((item, idx) => (
          <motion.div
            ...
            className="flex items-center gap-3 px-6 py-3 rounded-full bg-white border border-slate-100 shadow-subtle hover:border-primary/20 hover:shadow-premium transition-all cursor-pointer group"
          >
